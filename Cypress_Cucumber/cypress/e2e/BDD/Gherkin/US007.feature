Feature: 📑 US 007 - File Input Categoría Formulario - Previsualizacion de una imagen al una extension especifica en el File Input.
    ...
    Scenario Outline: 🧪 US 007 - TS 007 - TC 002: Intentar Validar - el File Input Category Image, al añadir extensiones Invalidas.
        When carga una imagen en el File Input Category Image, con una extension invalida como '<invalid_extension>'
        Then el File Input Category Image no deberia aparecer Ninguna Advertencia
